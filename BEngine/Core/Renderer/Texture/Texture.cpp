...
void Texture::TransitionLayout( VulkanContext* context, Texture* texture, CommandBuffer cmd, VkFormat format, VkImageLayout old_layout, VkImageLayout new_layout )
{
...
void Texture::CopyFromBuffer( VulkanContext* context, VkBuffer from_buffer, Texture* to_texture, CommandBuffer copy_cmd )
{
